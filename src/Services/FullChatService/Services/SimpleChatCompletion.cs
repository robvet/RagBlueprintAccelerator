...
{
    public class SimpleChatCompletion : ISimpleChatCompletion
    {
        private readonly ILogger<SimpleChatCompletion> _logger;
        ...
        public SimpleChatCompletion(IConfiguration configuration, ITokenManager tokenManager)
        {
